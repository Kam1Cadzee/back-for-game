...
import { SentenceCreateManyWithoutDisconnectEntitiesInput } from "../inputs/SentenceCreateManyWithoutDisconnectEntitiesInput";
...
export class EntityCreateWithoutDisconnectPhrasesInput {
  ...
  @TypeGraphQL.Field(_type => SentenceCreateManyWithoutDisconnectEntitiesInput, {
    nullable: true,
    description: undefined
  })
  disconnectSentences?: SentenceCreateManyWithoutDisconnectEntitiesInput | null | undefined;
}
